...
\begin{ModuloImplements}{ListaEnlazada<T>}{Secuencia<T>}
  ...
  \pred{sinCiclos}{nodo: \Clase{NodoLista}{T}, visitados: \conj{\Clase{NodoLista}{T}}}{
    nodo = Null \oLuego (nodo \notin visitados \yLuego sinCiclos(nodo.siguiente, visitados \union \{n_0\}))
  }
  ...
  \begin{proc}{eliminarUltimo}{\Inout l: \Clase{ListaEnlazada}{T}, penultimoNodo: \Clase{NodoLista}{T}}{}
    ...
    \end{ImplementationCode}
  \end{proc}
  \begin{proc}{eliminarRapido}{\Inout l: \Clase{ListaEnlazada}{T}, \In nodoPrevio: \Clase{NodoLista}{T}}{}
    \begin{ImplementationCode}{360px}
      if nodoPrevio == null then
        return sacarPrimero(c)
      endif
      
      if nodoPrevio.siguiente == l.ultimo
        return sacarUltimo(c, nodoPrevio)
      endif
  ...
  \begin{proc}{eliminar}{\Inout l: \Clase{ListaEnlazada}{T}, i: int}{}
    \begin{ImplementationCode}{350px}
      ...
      return eliminarRapido(l, nodoPrevio)
    \end{ImplementationCode}
  \end{proc}
    ...
    \begin{ImplementationCode}{320px}
      ...
      while (j < c2.tamaño) do
        if !pertenece(c1, c2.datos[j]) then
          nuevosDatos[c1.tamaño + j]:= c2.datos[j]
        endif
        j:= j + 1
      endwhile

      c.datos:= nuevosDatos
      c.tamaño:= c1.tamaño + c2.tamaño
...
\begin{ModuloImplements}{ConjuntoLista<T>}{ConjuntoAcotado<T>}
  ...
  \begin{proc}{agregarRapido}{\Inout c: \Clase{ConjuntoLista}{T}, t: T}{}
    ...
    \end{ImplementationCode}
  \end{proc}
  \begin{proc}{sacarRapido}{\Inout c: \Clase{ConjuntoLista}{T}, \In nodoPrevio: \Clase{NodoLista}{T}}{}
    \begin{ImplementationCode}{360px}
      c.datos.eliminarRapido(c.datos, nodoPrevio)
      c.tamaño:= c.datos.longitud
    ...
    \begin{ImplementationCode}{360px}
      ...
      while (nodoActual != null) do
        if nodoActual.valor == t then
          return sacarRapido(c, nodoPrevio)
        endif
...
\begin{ModuloImplements}{ConjuntoRapido}{{\Clase{Conjunto}{\Tupla{\ent, \ent, \ent}}}}
  ...
  \begin{proc}{agregarEnOrdenadosPorCoord}{\Inout c: \texttt{ConjuntoRapido}, \In coord: int, \In valorCoord: int}{}
    \begin{ImplementationCode}{460px}
      ...
      return actualizarOrdenadosPorCoord(c, coord, nuevosOrdenadosPorCoords)
    \end{ImplementationCode}
  \end{proc}
