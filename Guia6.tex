...
\begin{ModuloImplements}{ListaEnlazada<T>}{Secuencia<T>}
  ...
  \begin{proc}{eliminarPrimero}{\Inout l: \Clase{ListaEnlazada}{T}}{}
    ...
    \end{ImplementationCode}
  \end{proc}
  \begin{proc}{eliminarUltimo}{\Inout l: \Clase{ListaEnlazada}{T}, \In penultimoNodo: \Clase{NodoLista}{T}}{}
    \begin{ImplementationCode}{360px}
...
\begin{ModuloImplements}{ConjuntoAcotadoArr<T>}{ConjuntoAcotado<T>}
  ...
  \pred{invRep}{c: \Clase{ConjuntoAcotadoArr}{T}}{
    0 \leq c.tama$ñ$o < length(c.datos) \land
    sinRepetidos(c) \land
  ...
  \begin{proc}{agregar}{\Inout c: \Clase{ConjuntoAcotadoArr}{T}, t: T}{}
    ...
    \end{ImplementationCode}
  \end{proc}
  \begin{proc}{sacarSiPertenece}{\Inout c: \Clase{ConjuntoAcotadoArr}{T}, t: T}{}
    \begin{ImplementationCode}{320px}
      var i: int
          i:= 0
  ...
  \begin{proc}{intersecar}{\Inout c1: \Clase{ConjuntoAcotadoArr}{T}, \In c2: \Clase{ConjuntoAcotadoArr}{T}}{}
    \begin{ImplementationCode}{360px}
      ...
      while (i < c2.tamaño) do
        sacarSiPertenece(c1, c2.datos[i])
